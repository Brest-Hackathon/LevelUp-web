...
if "selected_user" in st.session_state:
    ...
    if user:
        ...
        # Debugging - print raw user data to check it
        st.write(f"Raw User Data: {user}")
        ...
        with col2:
            ...
            if signup_date:
                try:
                    ...
                    st.markdown("**Дата регистрации:** Некорректная дата")
            else:
            ...
            if last_login:
                try:
                    ...
                    st.markdown("**Последний вход:** Некорректная дата")
            else:
